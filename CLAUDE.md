...
30 SLURM scripts in `hpc/sweep/` for systematic hyperparameter search. Generated by `hpc/sweep/generate_jobs.py`.
...
**Submission:** `bash hpc/sweep/submit_all.sh [filter]` — filter by reward name, episode count, etc.
